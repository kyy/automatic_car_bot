...
TXT = dict(
    ...
    info_filter_menu_help='Нажав на фильтр можно увидеть сколько машин удовлетворяет твоему поиску. '
    ...
    info_save_search='Все текущие объявления можно сформировть как отчет в управлении фильтрами.\n',
    ...
    info_start_menu='Я помогу найти подходящий автомобиль.'
    ...
    info_add_stalk_menu='https://yoomoney.ru/to/4100118330778097Отправьте сюда ссылку. Можно отправить несколько разделив пробелом.',
    info_donate='Хотите отблагодарить монетой?\n'
