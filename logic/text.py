TXT = {
    ...
    'info_start_menu_help':
        ...
        '\n'
        'Cоздать фильтр - <b>/filter</b>  или  <b>/f</b>\n'
        '\n'
        'Показать все команды - <b>/com</b>  или  <b>/c</b>\n'
        '\n'
    ...
    'msg_finish_filter': '📌 Проверьте данные, если еобходимо отредактируйте перед сохранением.',
    'msg_added_url': '⚡ успешно добавлена',
    'msg_stalking_url': '⚠ ссылка отслеживается',
    'msg_error_url': '⚠ Неверная ссылка. Принимаем только с cars.av.by и ab.onliner.by',
