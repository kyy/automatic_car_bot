...
TXT = dict(
    ...
    msg_cars_limit='⚠ Вы превысили кол-во машин.',
    msg_cars_limit_Subs='⚠ Для индивидуального увеличения числа лимита обратитесь сюда.',
    msg_filter_limit='⚠ Вы превысили кол-во фильтров.',
    msg_filter_limit_Subs='⚠ Для индивидуального увеличения числа лимита обратитесь сюда.',
