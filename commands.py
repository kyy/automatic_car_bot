...
commands = [
    ...
    BotCommand(command="/donate", description="💸  Сказать спасибо", full_description=" Поддержать проект"),
    BotCommand(command="/help", description="⁉  Помощь", full_description=" Все команды с подробным описанием."),
]
