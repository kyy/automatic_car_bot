...
class PDF(FPDF):
    ...
    def colored_table(self, headings, rows, links, col_widths=(7, 30, 15, 20, 10, 17, 22, 12, 25, 17, 16, 8, 28, 23, 30)):
...
def get_data():
    columns = ['#', 'марка', 'цена', 'топливо', 'двигатель', 'коробка', 'пробег', 'год',
